...
/** PD Manager / Finance Manager sign-in — password-based. */
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <Card className="w-full max-w-sm">
        <CardHeader>
          ...
          <CardDescription>
            {mode === "signin" && "PD Manager / Finance Manager sign-in."}
        ...
        <CardContent>
          ...
          <div className="mt-4 space-y-1.5">
            ...
            <Link to="/staff-login" className="text-xs text-muted-foreground hover:text-primary block pt-1">
              PD Staff? Sign in here →
            </Link>
          </div>
        </CardContent>
      </Card>
